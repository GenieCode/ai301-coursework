...
(I am a beginner with Python and pytest. I prefer a small, focused issue with clear expected behavior and existing tests or documentation. I want to avoid broad architectural changes.)
